  ...
  (setq-default
   ...
   '(elixir
     ...
     (clojure :variables
              ...
              clojure--sym-forbidden-rest-chars "][\";\'@\\^`~\(\)\{\}\\,\s\t\n\r/"
...
before packages are loaded."
  ...
  ;; Fix do that you can paste os clipboard in vim-visual-state
  (fset 'evil-visual-update-x-selection 'ignore)
  ;; Find and replace only in actual selection instead of whole lines
  ...
  (load-file "~/.spacemacs.d/clojure.el")
  (load-file "~/.spacemacs.d/preferences.el"))


;; Do not write anything past this comment. This is where Emacs will
;; auto-generate custom variable definitions.
(load-file "~/.spacemacs.d/custom-settings.el")
